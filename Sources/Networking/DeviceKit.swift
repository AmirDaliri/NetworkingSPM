...
//
//
//  Created by Amir Daliri on 7.03.2024.
//
...
public enum Device {
  ...
  public var screenRatio: (width: Double, height: Double) {
    ...
    /// All Plus and Max-Sized Devices
    public static var allSmallSizedDevices: [Device] {
        return [.iPhone6, .iPhone6s, .iPhone7, .iPhone8, .iPhoneSE, .iPhoneSE2, .iPhoneSE3,
            .simulator(.iPhone6), .simulator(.iPhone6s), .simulator(.iPhone7), .simulator(.iPhone8), .simulator(.iPhoneSE), .simulator(.iPhoneSE2), .simulator(.iPhoneSE3)]
    }
